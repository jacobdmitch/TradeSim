...
*Generated 2026-08-12 from the local git checkout.*

## Highlights

- 7,184 lines across 42 code files. Primary language Python. Mix: Python 46%, Swift 41%, Shell 13%.
- 35 commits by 2 contributors, 2026-05-30 to 2026-07-26.
- 35 commits in the last 12 months (freshness / activity signal).
