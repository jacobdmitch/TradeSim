...
def _candidate_modal(cands: list, held: Optional[str]) -> str:
    ...
    return (
        ...
        "<p class='muted small'>Coins the last scan ranked by predicted edge, before "
        "fees. The engine then checks the leader clears its round-trip cost in both "
        "percent and dollars before it rotates.</p>"
